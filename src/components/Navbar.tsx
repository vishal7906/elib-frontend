      ...
      <nav className="border-b">
        <div className=" max-w-7xl mx-auto flex justify-between items-center py-4">
            ...
            <div className='flex items-center gap-3'>
                ...
                <button className="h-10 rounded-md border border-primary-500 bg-primary-500 px-4 py-2 text-sm font-medium text-white transition-all hover:bg-primary-600 active:bg-primary-700">Sign Up</button>
            </div>
        </div>
      </nav>
    );
